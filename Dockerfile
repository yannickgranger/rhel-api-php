...
#    dnf install -y php-devel gcc make autoconf libtool php-pear php83
#
...
#COPY --from=php_pecl_builder /extensions/json.so /usr/lib64/php/8.3/modules/
#COPY --from=php_pecl_builder /extensions/json.ini /etc/opt/remi/php83/php.d/
